...
\newpage	
	...
	\end{figure}
 	...
 	\includegraphics[scale=2]{P2_estimating1}\\\\
...
\\\\\\\\\\
	...
	I risultati ottenuti sono soddisfacenti, ottenendo una riduzione della sovraelongazione di più del 10 percento in entrambi i casi. Anche il tempo d' assestamento è stato diminuito in maniera soddisfacente, sebbene 
	\appendix
	...
	\end{figure}
	\begin{figure}
		\includegraphics[scale=0.38]{migliora_integrale_script}

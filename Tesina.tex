...
\newpage	
	...
	Sarà scelto il valore di N che genera un tempo d' assestamento minore ($\text{ta}=4096\text{ pu}=10.8\text{ s}$), quindi $N=0.1$. Con questa scelta si ottiene la funzione di trasferimento del PID:
	\begin{equation*}

...
\begin{document}
	...
	Avendo ora più chiaro il contesto in cui ci si pone possiamo capire come una variazione di domanda da parte di uno o più nodi presenti, o l' esistenza di disturbi sia all' interno dei sistemi di generazione sia nella rete, si distribuiscano in un sistema molto vasto, dando origine a delle variazioni di modesta entità a causa delle quali ha senso effettuare un' analisi di questo tipo. Bisogna inoltre tener presente che per via della grande frequenza di variazione della domanda è difficile che un power system sia per molto tempo in equilibrio. E' proprio in questo preciso frangente che vuole 
